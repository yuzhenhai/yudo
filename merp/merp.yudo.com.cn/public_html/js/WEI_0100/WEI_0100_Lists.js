    ...
    methods:{
        ...
        _updateLang:function(){
            ...
            this.list.db = [
                ...
                // {value:'YBD',text:'毅比道'},//this.lang.YIBIDAO
                // {value:'SH',text:'上海'},//this.lang.SHANGHAI
                // {value:'LL',text:'柳凌'},//this.lang.LIULING
                // {value:'LLSZ',text:'朗力苏州'},//this.lang.LLSZ
                // {value:'CL',text:'彻丽'},//this.lang.CHELI
                // {value:'SZJT',text:'苏州集团'},//text:this.lang.SZJT
                // {value:'GDJT',text:'广东集团'},//text:this.lang.GDJT
                // {value:'QDJT',text:'青岛集团'},//text:this.lang.QDJT
        ...
        getData(params,check,jt=0){
            http.getSync(this.api.getResults,params,res => {
               ...
               //新增上海、柳凌、朗力苏州、彻丽
                ...
                // leon.list.speakProduct = res.data.speakProduct;
                //  console.log('///////yuzh//////');
                // console.log(res.data.speakOrder);

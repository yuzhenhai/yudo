<?php /* Template_ 2.2.6 2018/09/20 11:02:14 /home/merp.yudo.com.cn/public_html/JLAMP_application/views/layout.html 000004684 */ ?>
<!DOCTYPE html>
<html lang="ko-kr">
<head>
...
<nav class="navbar navbar-fixed-top top_header" style="display:none;">
	<!-- 메뉴 아이콘 -->
	<div>
		<img id="imgTopLogo" src="/image/login_logo.png" border="0" alt="top logo" class="topLogo">
	</div>

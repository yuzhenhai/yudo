<?php /* Template_ 2.2.6 2018/02/01 15:22:49 /home/merp.yudo.com.cn/public_html/JLAMP_application/views/login.html 000003108 */ ?>
    ...
    <form id="frmLogin" method="post" action="/" onsubmit="return doLogin()">
		<div class="login_input_area">
			<ul>
                ...
                <li>
					<select id="login_lang_id" name="login_lang_id" style="	width: 99.4%;text-indent: 8px;background-color: #FFFFFF;border: 1px solid #b7b7b7;margin:0px 0px 0px 0px">

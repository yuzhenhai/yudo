...
$GLOBALS['_transient']['static']['__construct']['globalDebugLevel'] = 9;
...
class nusoap_base {
	...
	*/
	function __construct() {
		$this->debugLevel = $GLOBALS['_transient']['static']['__construct']['globalDebugLevel'];
	}
	...
	*/
	function getGlobalDebugLevel() {
		return $GLOBALS['_transient']['static']['__construct']['globalDebugLevel'];
	}
	...
	*/
	function setGlobalDebugLevel($level) {
		$GLOBALS['_transient']['static']['__construct']['globalDebugLevel'] = $level;
	}
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function __construct($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 1000, $portName = ''){
		parent::__construct();

    ...
    methods:{
        ...
        _updateLang:function(){
            ...
            this.list.db = [
                ...
                {value:'YBD',text:this.lang.YIBIDAO},//this.lang.YIBIDAO
                {value:'SH',text:this.lang.SHANGHAI},//this.lang.SHANGHAI
                {value:'LL',text:this.lang.LIULING},//this.lang.LIULING
                {value:'LLSZ',text:this.lang.LLSZ},//this.lang.LLSZ
                {value:'CL',text:this.lang.CHELI},//this.lang.CHELI
                {value:'SZJT',text:this.lang.SZJT},//this.lang.SZJT
                {value:'GDJT',text:this.lang.GDJT},//this.lang.GDJT
                {value:'QDJT',text:this.lang.QDJT},//this.lang.QDJT
        ...
        speakDataMinute:function(){
           ...
           setTimeout(function () {
            ...
            // // http.getSync(this.api.getChukou,params,res => {
                 jq('.yudo-window').css({'animation-duration':'0.6s'});
                    ...
                    console.log(res);
                    // leon.list.speakOrder = res.data.speakOrder;
                    // leon.list.speakInvoice = res.data.speakInvoice;
                    // leon.list.speakBill = res.data.speakBill;
                    // leon.list.speakReceipt = res.data.speakReceipt;
                    // leon.list.speakProduct = res.data.speakProduct;
                    // setTimeout(function () {
        ...
        buildDataMinute:function(index){
            ...
            // console.log(leon.list.orderList);
            setTimeout(function () {
                switch (index){
                    case 0:
                    leon.list.Yclick = 0;

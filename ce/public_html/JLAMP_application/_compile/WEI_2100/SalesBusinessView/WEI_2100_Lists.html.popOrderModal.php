<?php /* Template_ 2.2.6 2019/04/26 15:45:59 /home/merp.yudo.com.cn/public_html/JLAMP_application/views/SalesBusinessView/WEI_2100_Lists.html 000103471 */ ?>
<div id="leon" style="overflow-y:auto;height: 100%;position: relative">
    ...
    <div v-show="find_astable_show" style="z-index: 3;" class="yudo-window">
        ...
        <div class="center-ios">
            ...
            <div id="mui_pushitem" class="info-minute scroll" style="top:122px;">
                <div class="minute-project">
                    <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in asitemlist" v-on:click="set_asitem(index)">
                        <div class="minute-body" style="height: 75px">
                            <div class="tr flex">
                                <div class="title leon-8 long">$((langCode.itemNo)):$((item.ItemNo))</div>
                                <div>$((langCode.itemCd)):$((item.ItemCd))</div>
                            </div>
                            <div class="tr flex">
                                <div class="len-5 long ">$((langCode.spec)):$((item.Spec))</div>
                                <div >$((langCode.unitNm)):$((item.UnitNm))</div>
                            </div>
                            <div class="tr">
                                <div class="len-10 long">$((langCode.status)):$((item.ItemNm))</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub_contents" style="position: relative">
                ...
                <div class="search_area">
                    <div class="sub_title" j-word-label="W2018041913130033733">订单信息
                        <button class="layui-btn layui-btn-primary  layui-btn-sm " style="float: right;margin-top: -5px;margin-right: 5px" onclick="leon.unSubAdjudication()"  j-word-label="W2018071009254859784" >裁决上报取消</button>
                    ...
                    <table class="search_table">
                        ...
                        <tr>
                            <th j-word-label="W2018082315443716702">状态</th>
                            <td colspan="4" rowspan="1" style="padding-left:20px">
    ...
    <div v-show="find_orderlist_show"  style="z-index: 2;" class="yudo-window">
        ...
        <div class="center-ios">
            ...
            <div id="mui_pushorder" class="info-minute scroll" style="top:132px;">
                <div class="minute-project">
                    <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in orderlist" v-on:click="set_order(index)">
                        <div class="minute-body" style="height: 95px">
                            <div class="tr">
                                <div class="title">$((langCode.orderNo)):$((item.OrderNo))</div>
                            </div>
                            <div class="tr">
                                <div class="len-10 long">$((langCode.custNm)):$((item.custname))</div>
                            </div>
                            <div class="tr">
                                <div class="len-5 long left-text ">$((langCode.orderDate)):<span>$((item.OrderDate | mf_replace))</span></div>
                                <div class="right-text">$((langCode.empNm)):$((item.EmpNm))</div>
                            </div>
                            <div class="tr">
                                <div class="len-5 long left-text ">$((langCode.delvDate)):<span>$((item.DelvDate |  mf_replace))</span></div>
                                <div class="right-text">$((langCode.deptNm)):$((item.DeptNm))</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div v-show="find_custlist_show"  style="z-index: 2;" class="yudo-window">
        ...
        <div class="center-ios">
            ...
            <div id="mui_pushcust" class="info-minute scroll" style="top:132px;">
                <div class="minute-project">
                    <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in custlist" v-on:click="set_cust(index)">
                        <div class="minute-body" style="height: 75px">
                            <div class="tr">
                                <div class="title len-7 long">$((langCode.custNm)):$((item.CustNm))</div>
                                <div class="right-text">$((langCode.status)):<span v-html="$options.filters.custStatusChange(item.status,item.StatusId)"></span></div>
                            </div>
                            <div class="tr">
                                <div class="len-10 long">$((langCode.custCd)):$((item.CustCd))</div>
                            </div>
                            <div class="tr">
                                <div>$((langCode.trustOrUntrust)):$((item.KoOrFo | mf_koorfo))</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div v-show="find_speclist_show"  style="z-index: 2;" class="yudo-window">
        ...
        <div class="center-ios">
            ...
            <div id="mui_pushspec" class="info-minute scroll" style="top:132px;">
                <div class="minute-project">
                    <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in speclist" v-on:click="set_spec(index)">
                        <div class="minute-body" style="height: 90px">
                            <div class="tr">
                                <div class="title">$((langCode.specNo)):$((item.SpecNo))</div>
                                <!--<div style="float: left"><span v-html="$options.filters.confirmChange(item.CfmYn)"></span></div>-->
                                <div class="right-text" style="line-height: 19px">$((item.SpecType | mf_specclass))</div>
                            </div>
                            <div class="tr">
                                <div class="len-10 long">$((langCode.custNm)):$((item.CustNm))</div>
                            </div>
                            <div class="tr">
                                <div class="len-5 long left-text ">$((langCode.expClass)):$((item.ExpClss | mf_expclass))</span></div>
                                <div class="right-text">$((langCode.empNm)):$((item.EmpNm))</div>
                            </div>
                            <div class="tr">
                                <div class="len-5 long left-text ">$((langCode.specDate)):<span>$((item.SpecDate |  mf_replace))</span></div>
                                <div class="right-text">$((langCode.deptNm)):$((item.DeptNm))</div>
                            </div>
                        </div>
                    </div>
    ...
    <div v-show="find_aslist_show" style="z-index: 3;" class="yudo-window">
        ...
        <div class="center-ios" style="background-color: white">
                <div class="screen">
                    <div class="screen-power flex-left" @click="showAsListScreen($event)">
                        <div class="text">$((langCode.screen))</div>
                        <div class="icon-xiala screen-power-select"></div>
                    </div>
                    <input type="text" v-model="input_asid" :placeholder="langCode.orderNo" class="multi-find-windows search_input screen-pro">
                    <img class="screen-pro" src="/image/qrcode.png" v-on:click="qr_as()" width="29">
                    <button class="button-2000 screen-pro" v-on:click="query_as()" j-word-label="W2018020109095825029" style="width: 80px;font-size:15px">查询</button>
                    <div class="heng-line screen-pro"></div>
                </div>
                <div class="screen-body" v-show="asListScreen">
                    <div class="screen-body-pro">
                        <div class="flex-left input">
                            <div j-word-label="W2018041913373764065" style="width: 30%" class="screen-pro">职员名称</div>
                            <input type="text" v-model="input_asusername" class="multi-find-windows search_input screen-pro">
                        </div>
                        <div class="flex-left input" >
                            <div j-word-label="W2018041913134073778" style="width: 30%" class="screen-pro">客户名称</div>
                            <input type="text" style="min-width: 60%" v-model="input_ascustname" class="multi-find-windows search_input screen-pro">
                        </div>
                        <div class="flex-left input">
                            <div style="width: 30%" class="screen-pro">$((langCode.date))</div>
                            <div class="flex-left" style="width: 100%">
                                <input id="asStartDate" onfocus="this.blur();"  v-model="input_asStartDate" type="text"  name="fastclick" class="multi-find-windows search_input screen-pro" />-
                                <input id="asEndDate" onfocus="this.blur();"  v-model="input_asEndDate" type="text"  name="fastclick" class="multi-find-windows search_input screen-pro"/>
                            </div>
                        </div>
                        <div class="screen-body-submit flex">
                            <button class="yudo-btn-default clear" @click="asListScreenClear()">重置</button>
                            <button class="yudo-btn-default submit" @click="asListScreenCnf()">确定</button>
                        </div>
                    </div>
                    <div class="screen-body-bottom" @click="showAsListScreen($event)"></div>
                </div>
                <div id="mui_pushas" class="info-minute scroll" style="top:100px;">
                    <div class="minute-project">
                        <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in aslist" v-on:click="set_as(index);">
                            <div class="minute-body" style="height: 110px">
                                <div class="tr flex">
                                    <div class="title">$((langCode.asNo)):$((item.ASRecvNo))</div>
                                    <!--<div style="float: left"><span v-html="$options.filters.confirmChange(item.CfmYn)"></span></div>-->
                                    <div>$((langCode.status)):<span v-html="$options.filters.statusChange(item.Status)"></span></div>
                                </div>
                                <div class="tr flex">
                                    <div class="len-7 long">$((langCode.custNm)):$((item.CustNm))</div>
                                    <div class="len-2" >$((langCode.confirm)):<span v-html="$options.filters.confirmChange(item.CfmYn)"></span></div>
                                </div>
                                <div class="tr flex">
                                    <div class="len-5 long flex-left">$((langCode.orderNo)):$((item.OrderNo))&nbsp;<div class="flex-center" style="height: 15px;width: 15px;border: 1px solid #4c4c4c;border-radius: 3px">$((item.OrderCnt))</div></div>
                                    <div>$((langCode.productStatus)):<span v-html="$options.filters.productStatusChange(item.ProductStatus)"></span></div>
                                </div>
                                <div class="tr">
                                    <div class="len-5 long left-text ">$((langCode.asRecvDate)):<span>$((item.ASRecvDate | mf_replace))</span></div>
                                    <div class="right-text">$((langCode.empNm)):$((item.EmpNm))</div>
                                </div>
                                <div class="tr">
                                    <div class="len-5 long left-text ">AS$((langCode.delvDate)):<span>$((item.ASDelvDate |  mf_replace))</span></div>
                                    <div class="right-text">$((langCode.deptNm)):$((item.DeptNm))</div>
                                </div>
                            </div>
                        </div>
            ...
            <!--<div class="search_area" style="height:100%;padding-top: 80px">-->
                <!--<div>-->
                ...
                <!--<div  id="aslist_tr" class="multi-list-3" style="top:99px">-->
                <!--<table class="basic_table">-->
                    <!--<tr>-->
                        <!--<th style="text-align:center"><div class="basic_table_div" style="width: 30px">NO</div></th>-->
    ...
    <div v-show="find_userlist_show"  style="z-index: 2;" class="yudo-window">
        ...
        <div class="center-ios">
            ...
            <div id="mui_pushuser" class="info-minute scroll" style="top:160px;">
                <div class="minute-project">
                    <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in userslist" v-on:click="set_user(index)">
                        <div class="minute-body" style="height: 55px">
                            <div class="tr">
                                <div class="title len-10">$((langCode.empNm)):$((item.EmpNm))</div>
                            </div>
                            <div class="tr">
                                <div class="left-text len-5">$((langCode.empId)):$((item.EmpID))</div>
                                <div class="right-text">$((langCode.deptNm)):$((item.DeptNm))</div>
                            </div>
                        </div>
                    </div>
    ...
    <div v-show="find_assaleslist_show"  style="z-index: 3;" class="yudo-window">
        ...
        <div class="center-ios">
            ...
            <div id="mui_pushsales" class="info-minute scroll" style="top:160px;">
                <div class="minute-project">
                    <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in userslist" >
                        <div class="minute-body" style="height: 55px">
                            <div class="flex-left">
                                <div class="basic_table_div mui-input-row mui-checkbox" style="width: 50px">
                                    ...
                                    <input v-model="assales_checkbox" name="mui_checkbox" style="z-index: 2;left: 3px !important;top:0 !important;margin-top: 0 !important;" v-bind:value="item.EmpID" type="checkbox">
                                </div>
                                <div class="len-10">
                                    <div class="tr">
                                        <div class="title len-10">$((langCode.empNm)):$((item.EmpNm))</div>
        ...
        <div class="center-ios" style="background-color: white;">
            <table class="search_table">
                ...
                <tr>
                    ...
                    <td colspan="3" rowspan="1" style="padding-left:20px">
                        <div id="asunit" class="multi-select">
                            <input type="text" readonly="readonly" class="multi-input text-left" v-model="w_astable_UnitNm" />
                            <i class="layui-icon layui-icon-triangle-d"></i>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" rowspan="1" style="padding-left:20px">
                        <input v-bind:readonly="r_text1" v-model="w_astable_Qty" type="text"   class="multi-input text-left " data-date-format="yyyy-mm-dd">
                    </td>
                </tr>
                <tr>
                ...
                <tr rowspan="2">
                    <th j-word-label="W2018041913225420017">备注</th>
                    <td colspan="3" style="padding-left: 20px;">
                            <textarea  v-model="w_astable_Remark" v-bind:readonly="r_text1" type="text" class="text-left" style="border-radius: 5px !important; height: 58px; width: 100%;">
                            </textarea>
                    </td>
                </tr>
            </table>

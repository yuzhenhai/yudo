<?php /* Template_ 2.2.6 2020/03/18 11:03:27 /home/merp.yudo.com.cn/public_html/JLAMP_application/views/SalesBusinessView/WEI_2100_Lists.html 000098279 */ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>
...
<!--                            <button class="yudo-btn-primary" style="width: 100px;margin: 0 -10px 0 0" onclick="leon.unSubAdjudication()"  j-word-label="W2018071009254859784" >裁决上报取消</button>-->
                    ...
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body flex-left">
                            <div  class="input-border" style="flex: 1">
                                <input v-bind:readonly="disabled"  type="text"  v-model="w_model_id"  class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body flex-left">
                            <div  class="input-border">
                                <input v-bind:readonly="disabled" type="text" v-model="w_custprsn" class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body">
                            <div  class="input-border">
                                <input v-bind:readonly="disabled" type="text"  v-model="w_custtell" class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body">
                            <div  class="input-border">
                                <input v-bind:readonly="disabled" type="text" v-model="w_custemail" class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    <div class="input-tr" style="margin-bottom: 10px">
                    ...
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body">
                            <div  class="input-border" >
                                <input v-bind:readonly="disabled" type="text" v-model="w_asservicearea" class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    <div class="input-tr">
                    ...
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body">
                            <div  class="input-border" >
                                <input v-bind:readonly="disabled" type="text" v-model="w_cust_produce_name" class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    <div class="input-tr">
                        ...
                        <div  class="input-tr-body">
                            <div  class="input-border" >
                                <input v-bind:readonly="disabled" type="text" v-model="w_asplastic" class="yudo-input noborder">
                            </div>
                        </div>
                    </div>
                    <div class="input-tr">
                    ...
                    <div class="input-tr" style="margin-bottom: 10px">
                        ...
                        <div class="input-tr-body">
                            <div class="input-border-textarea">
                                <textarea type="text"  v-bind:readonly="disabled" v-model="w_text1" class="yudo-textarea noborder"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="input-tr" style="margin-bottom: 10px">
                        ...
                        <div class="input-tr-body">
                            <div class="input-border-textarea">
                                <textarea type="text"  v-bind:readonly="disabled" v-model="w_text2" class="yudo-textarea noborder"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="input-tr" style="margin-bottom: 10px">
                        ...
                        <div class="input-tr-body">
                            <div class="input-border-textarea">
                                <textarea type="text"  v-bind:readonly="disabled" v-model="w_text3" class="yudo-textarea noborder"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="input-tr" style="margin-bottom: 10px">
                        ...
                        <div class="input-tr-body">
                            <div class="input-border-textarea">
                                <textarea type="text"  v-bind:readonly="disabled" v-model="w_text4" class="yudo-textarea noborder"></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="yudo-scroll">
                <div class="area">
                    ...
                    <div class="input-tr">
                        ...
                        <div class="input-tr-body">
                            <div class="input-border">
                                <input v-bind:readonly="disabled" type="number" v-model="w_astable_Qty" class="yudo-input noborder" />
                            </div>
                        </div>
                    </div>
                    <div class="input-tr">
                    ...
                    <div class="input-tr">
                        ...
                        <div class="input-tr-body">
                            <div class="input-border">
                                <input  v-bind:readonly="disabled" type="number" v-model="w_astable_Remark" class="yudo-input noborder" />
                            </div>
                        </div>
                    </div>
                </div>

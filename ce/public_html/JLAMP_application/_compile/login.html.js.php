<?php /* Template_ 2.2.6 2019/03/21 12:56:52 /home/merp.yudo.com.cn/public_html/JLAMP_application/views/login.html 000005114 */ ?>
<!--jquery vue-->
...
<div class="body_back">
    ...
    <form id="frmLogin" method="post" action="/" onsubmit="return doLogin()">
		<div class="login_input_area">
			<ul>
				<li>
					<select id="login_service_id" name="login_lang_id" style="width:100%; height: 34px;text-indent: 8px;text-indent: 5px;background-color: #FFFFFF;border: 1px solid #b7b7b7;margin:0px 0px 0px 0px">

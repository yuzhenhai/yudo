...
class ImagesGdDriver {
     ...
     */
    public function thumb($width, $height, $type = Images::IMAGE_THUMB_SCALE) {
        if (empty($this->img))
            E('没有可以被缩略的图像资源');
        ...
        switch ($type) {
            ...
            /* 居中裁剪 */
            case Images::IMAGE_THUMB_CENTER :
                // 计算缩放比例
            ...
            /* 左上角裁剪 */
            case Images::IMAGE_THUMB_NORTHWEST :
                // 计算缩放比例
                $scale = max($width / $w, $height / $h);
            ...
            /* 右下角裁剪 */
            case Images::IMAGE_THUMB_SOUTHEAST :
                // 计算缩放比例
                $scale = max($width / $w, $height / $h);
            ...
            /* 填充 */
            case Images::IMAGE_THUMB_FILLED :
                // 计算缩放比例
                if ($w < $width && $h < $height) {
                    $scale = 1;
                } else {

...
class Multi_apiconsole extends Multi_apisetting{
    ...
    //百度GPS经纬度纠正
    private static $restoreGpsUrl = 'http://api.map.baidu.com/geoconv/v1';
    //百度GPS经纬度转换
    ...
    public static function restoreGps(&$lng,&$lat){
        $url = self::$restoreGpsUrl.'/?coords='.$lng.','.$lat.'&from=1&to=5&ak='.self::$gpsKey;

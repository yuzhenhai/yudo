<?php /* Template_ 2.2.6 2019/11/06 19:30:39 /home/gdmerp.yudo.com.cn/public_html/JLAMP_application/views/SalesBusinessView/WEI_2100_Lists.html 000108145 */ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>
...
<!--                    <div class="right-icon icon-extend"></div>-->
    ...
    <div v-show="find_astable_show" style="z-index: 102;" class="yudo-window">
        <div class="header-ios">
            <div class="header-body">
...
<!--                    <div class="right-icon icon-extend"></div>-->
    ...
    <div v-show="find_orderlist_show"  style="z-index: 102;" class="yudo-window-trans animated fadeInRight trans-1">
        <div class="header-ios">
            <div class="header-body">
        ...
        <div class="center-ios">
            <div class="search_area" style="position: absolute;top: 50px;border-bottom: 1px solid #e7e7e7">
                <div class="input-tr">
                    <div style="width: 80px" class="input-tr-title long"><div class="input-title" >订单号码</div></div>
                    <div  class="input-tr-body flex-left">
                        <div class="input-border" style="margin-right: 5px">
                            <input type="text"  v-model="input_orderno" class="yudo-input noborder">
                        </div>
                        <img src="/image/qrcode.png" style="margin-right: 5px" v-on:click="qr_order()" width="29">
                        <div style="flex-shrink: 1;width: 60px;height: 38px">
                            <button class="yudo-btn-white"   v-on:click="query_order()" j-word-label="W2018020109095825029" style="flex-shrink: 1;width: 60px;font-size:15px">查询</button>
                        </div>
                    </div>
                </div> 
                <div class="input-tr" style="margin-bottom: 10px">
                    <div style="width: 80px" class="input-tr-title long"><div j-word-label="W2018041913362840092" class="input-title" >客户名称</div></div>
                    <div  class="input-tr-body flex-left">
                        <div class="input-border">
                            <input type="text"  v-model="input_custname"  class="yudo-input noborder">
                        </div>
                    </div>
                </div>
            </div>
            <div id="mui_pushorder" class="info-minute scroll" style="top:155px;">
                <div class="minute-project">
        ...
        <div class="center-ios" style="background-color: white;">
            <div class="yudo-scroll">
                <div class="area">
                    ...
                    <div class="input-tr">
                        <div class="input-tr-title long" ><span j-word-label="W2018062810504422036">品目编码</span></div>
                        <div class="input-tr-body">
                            <div class="input-border">
                                <div class="pop-modal-power"><span class="mui-icon mui-icon-more"></span></div>
                    ...
                    <div class="input-tr">
                        <div class="input-tr-title long"><span j-word-label="W2018062810511435013">品目名称</span></div>
                        <div class="input-tr-body">
                            <div class="input-border long">
                                <div class="pop-modal-power"><span class="mui-icon mui-icon-more"></span></div>
                    ...
                    <div class="input-tr">
                        <div class="input-tr-title long"><span  j-word-label="W2018071013040628794">单位</span></div>
                        <div class="input-tr-body">
                            <div class="input-border">
                                <div class="icon-xiala select-btn"></div>

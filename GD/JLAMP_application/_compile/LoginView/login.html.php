<?php /* Template_ 2.2.6 2020/03/19 16:21:18 /home/gdmerp.yudo.com.cn/public_html/JLAMP_application/views/LoginView/login.html 000006968 */ ?>
<!DOCTYPE HTML>
<html>
<head>
	<title>
	...
	<!--css-->
	<link rel="stylesheet" href="/css/mui.min.css?v=1020">
	<link rel="stylesheet" href="/css/yudo-ui.css?v=1054">
	<link rel="stylesheet" href="/css/login.css?v=1059">
	<!-- bootstrap 3.3.5-->
	<link href="/third_party/bootstrap-3.3.5/css/bootstrap.css" rel="stylesheet">
	<link rel="stylesheet" href="/css/common.css?v=5008">
	...
	<script src="/js/login.js?v=20010"></script>
...
<div class="body_back">
	...
	<div class="language-switch">
		<select id="login_lang_id" name="login_lang_id" style="width: auto;padding: 0;font-size: 14px;color: #777777;right: 5px" onchange="langChange()">
	...
	<div class="login_logo">
		<div class="icon-logo2"></div>
	</div>
	<div class="login_header flex-center">
		<div>&nbsp;Mobile ERP&nbsp;<span id="version"></span></div>
	</div>
	<script>
		jq('#area').text(area);
	</script>
	...
	<div style="height: 100%;padding-top: 150px">
			<div class="login_input_area">
				<ul class="login-ul">
					<li>
						...
						<select onchange="serverOnchange(this.options[this.options.selectedIndex].value)" id="login_service_id" name="login_lang_id" style="padding-left: 50px" class="yudo-select noborder">
							<option  value="SZ">YUDO SZ</option>
							<option value="GD">YUDO GD</option>
							<option  value="DEV">YUDO DEV</option>
						</select>
					</li>
					<li>
						<div class="login-icon icon-login-username" style="width: 25px;height: 25px"></div>
						<div class="input-icon-bg"></div>
						<input id="login_id" type="text" class="yudo-input noborder" style="padding-left:50px !important;"  value="<?php echo $TPL_VAR["loginID"]?>" placeholder="ID" required autocomplete="off"/>

					</li>
					<li>
						<div class="login-icon icon-login-password" style="width: 25px;height: 25px"></div>
						<div class="input-icon-bg"></div>
						<input id="login_pwd" type="password" class="yudo-input noborder" style="padding-left: 50px !important;"  placeholder="PASSWORD" required autocomplete="off"/>
					</li>
					<li>
			...
			<div class="login_bn_area" style="padding: 10px 10% 7px 10%;">
				<input type="submit" onclick="doLogin()" id="btn_login"  class="yudo-login-btn"  value="LOGIN">
			</div>

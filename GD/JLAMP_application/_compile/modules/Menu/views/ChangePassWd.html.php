<?php /* Template_ 2.2.6 2019/01/29 14:36:03 /home/gdmerp.yudo.com.cn/public_html/JLAMP_application/modules/Menu/views/ChangePassWd.html 000004778 */ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>
        ...
        <div class="yudo-content">
            <div class="header-ios">
                <div class="header-body">
                    <div class="header-left-btn" @click="closeChangePassWd()">
            ...
            <div class="center-ios">
                <div style="height: 200px;width: 100%;padding: 70px 30px 0 30px">
                    ...
                    <div class="input-tr">
                        <div class="input-tr-body" style="width: 100%">
                            <button class="yudo-btn" @click="savePassWd()">保存</button>
                        </div>
                    </div>
...
<script src="/js/Menu/ChangePassWd.js?v=1001"></script>
</html>
<?php /* Template_ 2.2.6 2019/02/14 14:32:54 /home/gdmerp.yudo.com.cn/public_html/JLAMP_application/modules/WEI_2200/views/WEI_2200_Lists.html 000057077 */ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>
    ...
    <!--css-->
    <link rel="stylesheet" href="/css/yudo-ui.css?v=1052">
...
<div class="yudo-content" id="leon">
    ...
    <div class="yudo-menu" v-show="menuBuild">
        <div class="header-ios">
            <div class="header-body">
                ...
                <div class="header-center-btn">工作计划</div>
        ...
        <div class="center-ios">
            <div class="menus">
                <button @click="QueryOpen()" type="button" class="menu-btn" style="padding-top: 2px">
                    <span style="position: relative"><div class="icon-search btn-icon"></div><span j-word-label="W2018102616">查询工作计划/报告信息</span></span>
                </button>
                <button @click="planInfoOpen()" type="button" class="menu-btn" style="padding-top: 2px">
                    <span style="position: relative"><div class="icon-search btn-icon"></div><span j-word-label="W201810261">工作计划统计</span></span>
                </button>
                <button @click="addPlanOpen()" type="button" class="menu-btn" style="padding-top: 2px">
                    <span style="position: relative"><div class="icon-write btn-icon"></div><span j-word-label="W201810261">新增工作计划</span></span>
                </button>
    ...
    <div v-show="dateListBuild" style="z-index: 2;" class="find-window">
        <div class="header-ios">
            <div class="header-body">
                ...
                <div class="header-center-btn">工作计划/报告查询</div>
                <div class="header-right-btn">
                    <div class="right-icon icon-extend"></div>
                </div>
            </div>
    ...
    <div class="yudo-window" v-if="viewPlanData">
        <div class="header-ios">
            <div class="header-body">
                ...
                <div class="header-center-btn" >工作计划统计</div>
                <div class="header-right-btn">
                    <div class="right-icon icon-extend"></div>
                </div>
            </div>
                        ...
                        <div class="minute-list" style="border-bottom: 5px solid #f9f9f9;" v-for="(item,index) in planCountList" >
                            <div class="minute-body" style="height: 60px" v-bind:style="{'background':item.background,'border-left-color':item.background,'color':item.color}" >
                                ...
                                <div class="minute-body-th">
                                    <div class="minute-body-td long">工作计划：$((item.PlanCount))</div>
                                    <div class="minute-body-td long">工作报告：$((item.ReptCount))</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="slide_panel" v-show="planMinuteBuild" style="padding-top:50px;">
        ...
        <div class="header-ios">
            <div class="header-body">
                ...
                <div class="header-center-btn">新增工作计划</div>
                <div class="header-right-btn">
                    <div class="right-icon icon-extend"></div>
                </div>
            </div>
    ...
    <div id="slide_panel2" v-show="reptMinuteBuild" style="padding-top:50px;">
        <div class="header-ios">
            <div class="header-body">
                ...
                <div class="header-center-btn">新增工作报告</div>
                <div class="header-right-btn">
                    <div class="right-icon icon-extend"></div>
                </div>
            </div>
    ...
    <div v-show="planPhotoBuild" style="z-index: 2;" class=" find-window">
        <div class="header-ios">
            <div class="header-body">
    ...
    <div v-show="reptPhotoBuild" style="z-index: 2;" class="find-window">
        <div class="header-ios">
            <div class="header-body">
    ...
    <div v-show="dateQueryBuild"  style="z-index: 2;" class="find-window">
        <div class="header-ios">
            <div class="header-body">
    ...
    <div v-show="userListBuild"  style="z-index: 2;" class="find-window">
        <div class="header-ios">
            <div class="header-body">
    ...
    <div v-show="custListBuild"  style="z-index: 2;" class="find-window">
        <div class="header-ios">
            <div class="header-body">
...
<script src="/js/WEI_2200/WEI_2200_Lists.js?v=7512"></script>
